...
const DownloadCardModal: React.FC<DownloadCardModalProps> = ({
  show,
  handleClose,
}) => {
  return (
      ...
      <Modal.Body className="text-center dashboard-text-color">
        ...
        <Row>
          <Card className="mb-2 border-0 m-0">
            <Card.Body className="d-flex w0199 justify-content-between align-items-center">
              ...
              /> */}
              <label className="container1 me-4">
